...
/*
 * Initializes the RGB LED settings per channel, including the gpio for
 * each color, mode and timer configurations
 */
static void rgb_led_pwm_init(void)  // static to this file
{
	int rgb_ch;
...
{
	//values should be 0-255 for 8 bit resolution
